...
from .room_utils import generate_room, generate_fixed_room
...
class SokobanEnv(gym.Env):
    ...
    def _calc_reward(self):
        ...
        current_boxes_on_walls = self._calc_ball_on_walls()
        self.reward_last -= self.penalty_for_collisions * (current_boxes_on_walls - self.current_collisions)
        self.current_collisions = current_boxes_on_walls
